...
//           return(
//             <div key={product.id} className='flex flex-col items-start justify-center gap-5'>
//             <Image src={"product.image"} alt = "product.name" width={0} height={0} sizes="100vw" style={{width: '100%'}} className = 'aspect-square rounded-t-md object-cover shadow-lg hover:cursor-pointer'/>
